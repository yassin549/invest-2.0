...
@section('panel')
    @push('topBar')
        @include('admin.time_setting.top_bar')
    @endpush
    <div class="row">
        <div class="col-lg-12">
                            ...
                            <tbody>
                                @forelse($times as $time)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" data-id="{{ $time->id }}" data-name="{{ $time->name }}" data-time="{{ $time->time }}" data-route="{{ route('admin.time.update', $time->id) }}" data-bs-toggle="modal" data-bs-target="#editModal" class="btn btn-outline--primary editBtn btn-sm me-2"><i class="las la-pen"></i>@lang('Edit')</a>
                                            @if ($time->status)
