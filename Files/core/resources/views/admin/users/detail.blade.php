    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-4 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.ticket.pending', $user->id) }}" title="Pending Ticket" icon="las la-ticket-alt" value="{{ $pendingTicket }}" bg="18" type="2" />
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.users.update', [$user->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-12">
                                <div class="form-group">
                                    <label>@lang('Is Deleted') </label>
                                    <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Yes')" data-off="@lang('No')" name="is_deleted" @if($user->is_deleted) checked @endif>
                                </div>
                            </div>
                            <div class="col-md-12">
...
@pushIf(!gs('spa'), 'breadcrumb-plugins')
