...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.report.invest.history') }}" icon="las la-chart-bar" title="Total Investment" value="{{ showAmount($invest['invests']) }}" bg="primary" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.report.transaction') }}?remark=interest" icon="las la-chart-pie" title="Total Interest" value="{{ showAmount($invest['interests']) }}" bg="1" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.report.invest.history') }}?status=1" icon="las la-chart-area" title="Active Investments" value="{{ showAmount($invest['active_invests']) }}" bg="14" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.report.invest.history') }}?status=0" icon="las la-chart-line" title="Closed Investments" value="{{ showAmount($invest['closed_invests']) }}" bg="19" outline="true" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
