...
<body>
    ...
    <div class="preloader">
        <div class="preloader__imges">
            <img src="{{ frontendImage('preloader', @$preloader->data_values->image_one, '120x120') }}" class="preloader__img one" alt="@lang('No Image')">
            <img src="{{ frontendImage('preloader', @$preloader->data_values->image_two, '120x120') }}" class="preloader__img two" alt="@lang('No Image')">
        </div>
    </div>
