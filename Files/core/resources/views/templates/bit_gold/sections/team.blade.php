...
@endphp
<section class="pt-120 pb-120 bg_img" data-background="{{ frontendImage('team',@$teamCaption->data_values->image,'1920x1281') }}">
      <div class="container">
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="team-card">
              <div class="team-card__thumb">
                <img src="{{ frontendImage('team', @$teamElement->data_values->image,'280x296') }}" alt="image">
              </div>
