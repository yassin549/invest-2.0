                                    ...
                                    <tbody>
                                        @forelse($deposits as $deposit)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($deposit->method_code >= 1000 && $deposit->method_code <= 5000)
                                                        <a href="javascript:void(0)" class="icon-btn base--bg text-white detailBtn"  data-info="{{ json_encode($details) }}" @if ($deposit->status == Status::PAYMENT_REJECT) data-admin_feedback="{{ $deposit->admin_feedback }}" @endif>
                                                            <i class="fas fa-desktop"></i>
                                                        </a>
                                                    @else
                                                        <button type="button" class="icon-btn base--bg text-white" data-bs-toggle="tooltip" title="@lang('Automatically processed')">
