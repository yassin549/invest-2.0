...
@section('content')
    ...
    <div class="cmn-section">
        <div class="container ">
            <div class="text-end">
                <a href="{{ route('user.withdraw.history') }}" class="btn btn--base">@lang('Withdrawal History')</a>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <form action="{{ route('user.withdraw.money') }}" method="post" class="withdraw-form">
                        @csrf
                        <div class="gateway-card @if ($isHoliday && !gs('holiday_withdraw')) custom--card card countdown-card @endif">
