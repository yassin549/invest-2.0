                                ...
                                <div class="row gy-4 align-items-center">
                                    <div class="col-lg-4 col-md-6">
                                        <div class="d-flex align-items-center raking-invest">
                                            ...
                                            <div>
                                                ...
                                                <h5>{{ showAmount($user->total_invests) }} / {{ showAmount($nextRanking->minimum_invest) }}</h6>
                                                    @if ($nextRanking->minimum_invest - $user->total_invests > 0)
                                                        <span>{{ showAmount($nextRanking->minimum_invest - $user->total_invests) }} @lang('To unlock')</span>
                                                    @endif
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="raking-common text-center">
                                            ...
                                            <h5>{{ showAmount($user->team_invests) }} / {{ showAmount($nextRanking->min_referral_invest) }}</h5>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6">
                                        <div class="raking-common text-center">
                                            <span>@lang('Bonus')</span>
                                            <h5>{{ showAmount($nextRanking->bonus) }}</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="invest-badge text-center">
                                    <div class="invest-badge__thumb">
                                        <div class="invest-badge__thumb__mask {{ $nextRanking && $nextRanking->id < $userRanking->id ? 'badge-lock' : '' }}" data-progress="{{ $nextRanking && $nextRanking->id < $userRanking->id ? 0 : $progressPercent }}">
                                    ...
                                    <p class=invest-badge__subtitle>@lang('Bonus') - {{ showAmount($userRanking->bonus) }}</p>
                                    <ul class="invest-badge__list invest-badge__details  invest-badge__details-{{ $loop->iteration % 4 == 0 ? 4 : $loop->iteration % 4 }} {{ $loop->iteration % 3 == 0 ? 'invest-badge__detail_one' : 'invest-badge__detail_two' }}">
                                        ...
                                        <li class="d-flex "><span>@lang('Minimum Invest')</span>
                                            <span>: {{ showAmount($userRanking->minimum_invest) }}</span>
                                        </li>
                                        ...
                                        <li class="d-flex "><span>@lang('Team Invest')</span>
                                            <span>: {{ showAmount($userRanking->min_referral_invest) }}</span>
                                        </li>
