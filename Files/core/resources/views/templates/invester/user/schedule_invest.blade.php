                ...
                @forelse($scheduleInvests as $scheduleInvest)
                    ...
                    <div class="plan-item-two">
                        <div class="plan-info plan-inner-div">
                            ...
                            <p class="plan-value date">{{ __($scheduleInvest->plan->name) }} | {{ showAmount($scheduleInvest->amount) }}</p>
                        </div>
                        ...
                        <div class="plan-inner-div mt-4 d-flex flex-wrap gap-2 justify-content-end">
                            <button class="btn btn--base btn--smd detailsBtn" data-schedule_invest="{{ $scheduleInvest }}" data-interest="{{ getAmount($interest) }}" data-next_invest="{{ $scheduleInvest->next_invest ? showDateTime($scheduleInvest->next_invest) : '-----' }}">
                                @lang('Details')
                            </button>
