                    ...
                    <div class="row gy-4">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control form--control h-45" value="{{ old('name',@$user->fullname) }}" @if($user && $user->profile_complete) readonly @endif required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>@lang('Email')</label>
                                <input type="email" name="email" class="form-control form--control h-45" value="{{  old('email',@$user->email) }}" @if(@$user->email) readonly @endif required>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
