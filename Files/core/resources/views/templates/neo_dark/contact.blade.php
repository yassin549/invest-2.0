                        ...
                        <form class="contact-form verify-gcaptcha" action="{{ route('contact') }}" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input name="name" type="text" placeholder="@lang('Enter your name')" class="form-control" value="{{ old('name',@$user->fullname) }}" @if($user && $user->profile_complete) readonly @endif required autocomplete="off">
                                </div>
                                <div class="form-group col-lg-6">
