                                ...
                                @foreach ($blogs as $k => $data)
                                    <li class="small-post">
                                        <div class="small-post__thumb">
                                            <a href="{{ route('blog.details', $data->slug) }}"><img src="{{ frontendImage('blog', 'thumb_' . $data->data_values->image) }}" alt=""></a>
                                        </div>
                                        <div class="small-post__content">
                                            <h5 class="post__title"><a href="{{ route('blog.details', $data->slug) }}">{{ __($data->data_values->title) }}</a></h5>
                                            <ul class="post__meta">
