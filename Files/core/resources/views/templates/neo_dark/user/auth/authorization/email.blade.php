            ...
            <div class="verification-code-wrapper">
                <div class="verification-area">
                    <form action="{{route('user.verify.email')}}" method="POST" class="submit-form">
                        ...
                        <div class="mb-3">
                            <p>
                                @lang('If you don\'t get any code'), <span class="countdownWrapper">@lang('try again after') <span id="countdown" class="fw-bold">--</span> @lang('seconds')</span> <a href="{{route('user.send.verify.code', 'email')}}" class="try-again-link forget-pass d-none"> @lang('Try again')</a>
                            </p>
