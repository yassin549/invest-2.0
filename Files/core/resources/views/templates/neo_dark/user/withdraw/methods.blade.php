    ...
    <section class="pb-150 pt-150">
        <div class="container">
            <div class="row justify-content-center">
                <div class=" {{ $isHoliday && !gs('holiday_withdraw') ? 'col-xl-6 col-lg-8' : 'col-xl-10' }}">
                        ...
                        <form action="{{ route('user.withdraw.money') }}" method="post" class="withdraw-form">
                            ...
                            <div class="gateway-card">
                                <div class="row justify-content-center gy-sm-4 gy-3">
                                    <div class="col-lg-6">
                                        <div class="payment-system-list is-scrollable gateway-option-list card-bg">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="payment-system-list p-3 card-bg">
