                            ...
                            <tbody>
                                ...
                                @forelse($withdraws as $withdraw)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-primary w-auto detailBtn" data-user_data="{{ json_encode($withdraw->withdraw_information) }}" @if ($withdraw->status == 3) data-admin_feedback="{{ $withdraw->admin_feedback }}" @endif><i class="la la-desktop"></i></button>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
